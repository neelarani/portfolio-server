...
const router = Router();
router.post('/', auth(Role.ADMIN), fileUploader.upload.single('file'), validateRequest(validation.postSchema), controller.createPost);
router.get('/', controller.getAllPost);
router.get('/:id', controller.getSinglePost);
router.patch('/:id', auth(Role.ADMIN), validateRequest(validation.updatePostSchema), controller.updatePost);
